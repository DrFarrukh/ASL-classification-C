...
echo "Starting ASL classifier with GUI display..."
...
# Run the Docker container with I2C device access and X11 forwarding
sudo docker run --runtime nvidia -it --rm \
    ...
    bash -c "cd /asl && (python3 realtime_classifier_simple.py --use-jit --threshold 0.3 | python3 asl_gui_display.py)"

echo "ASL classifier with GUI display exited."
